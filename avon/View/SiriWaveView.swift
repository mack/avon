...
public class SiriWaveView: UIView {
    ...
    public private (set) var amplitude: CGFloat = 0.1
    
    @IBInspectable
    public var idleAmplitude: CGFloat = 0.001
    @IBInspectable
    public var speed: CGFloat = 0.2

    public var colors: [UIColor] = [UIColor(rgb: 0xFF4C4C),
                                    UIColor(rgb: 0x3AE736),
                                    UIColor(rgb: 0x3660E7)]
    ...
    private func drawSupportLine(_ ctx: CGContext) {
        ...
        let colorLocations: [CGFloat] = [0.1, 0.1, 1.0, 0.8, 1]
